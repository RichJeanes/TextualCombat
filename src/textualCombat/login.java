...
public class login {
	...
	public boolean add_user(Map<String, AttributeValue> item){
        if(does_user_exist(item.get("user_name").getS())) return false;
	...
	public void update_char(String char_name, int health, int attack, int defence, int strength, int agility){
	...
	public Map<String, AttributeValue> new_char_item(String char_name, String user_name, int health, int attack, int defence, int strength, int agility){
		Map<String, AttributeValue> item = new HashMap<String, AttributeValue>();
